...
<body>
    ...
    <div class="card-deck mb-3 text-center">
      ...
      <div class="card mb-3 shadow-sm">
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-lg btn-block btn-outline-primary">Aï¿½adir al carrito</button>
        </div>
      </div>
      <div class="card mb-3 shadow-sm">
        <div class="card-header">
          <h4 class="my-0 font-weight-normal">Chuletï¿½n de ternera</h4>
          <marquee scrollamount="1" scrolldelay="10" truespeed width="200" style="color:red"><n>ï¿½ï¿½OFERTA!!</n></marquee>
        </div>
        <div class="card-body">
          ...
          <button type="button" class="btn btn-lg btn-block btn-outline-info">Aï¿½adir al carrito</button>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="perfumeria">
    ...
    <div class="card-deck mb-3 text-center">
      ...
      <div class="card mb-3 shadow-sm">
        <div class="card-header">
          <h4 class="my-0 font-weight-normal">JOHNSON'S Colonia suave para bebï¿½ - 750ml</h4>
          <marquee scrollamount="1" scrolldelay="10" truespeed width="200" style="color:red"><n>ï¿½ï¿½OFERTA!!</n></marquee>
        </div>
        <div class="card-body">
  ...
  <section id="ropa">
    ...
    <div class="card-deck mb-3 text-center">
      ...
      <div class="card mb-3 shadow-sm">
        <div class="card-header">
          <h4 class="my-0 font-weight-normal">Pantalï¿½n Escalada Turia Jean Snow Hombre.</h4>
          <marquee scrollamount="1" scrolldelay="10" truespeed width="200" style="color:red"><n>ï¿½ï¿½OFERTA!!</n></marquee>
        </div>
        <div class="card-body">
  ...
  <section id="bazar">
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      ...
      <p class="lead">Pasatï¿½ por la secciï¿½n de bazar en nuestra tienda para llevarte productos de 1ï¿½ calidad</p>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-6 col-md">
        ...
        <ul class="list-unstyled text-small">
          <li><a target="_blank" class="text-muted" target="_blank" href="https://github.com/albertogomezp">Alberto Gomez Peï¿½a</a></li>
          <li><a target="_blank" class="text-muted" target="_blank" href="https://github.com/ivanperezmolina">Ivï¿½n Pï¿½rez Molina</a></li>
        </ul>
      </div>
      <div class="col-6 col-md">
        <h5>Repositorio</h5>
